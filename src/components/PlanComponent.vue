        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="card card-primary">
                        ...
                        <form @submit.prevent="CreatePlan">
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group ml-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" required v-model="name" id="exampleInputEmail1" placeholder="ກະລຸນາປ້ອນຊື່">
                                    </div>
                                    <div class="form-group ml-3 mb-3">
                                        <label for="exampleInputEmail1">ເປີເຊັນ:<span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" required v-model="percent" id="exampleInputEmail1" placeholder="%">
                                    </div>
                            ...
                            <div class="card-footer">
                                <button type="reset" class="btn btn-danger"><i class="fas fa-times mr-1"></i>ຍົກເລິກ</button>&nbsp;&nbsp;<button type="submit" class="btn btn-primary"><i class="fas fa-print mr-1"></i>ບັນທຶກ</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-between">
                      <router-link to ="/plan-success" class="btn btn-primary btn-sm"><i class="fas fa-arrow-circle-right mr-1"></i>ເເຜນທີ່ສຳເລັດ </router-link>
                      <router-link to ="/plan-unsuccess" class="btn btn-danger btn-sm"><i class="fas fa-arrow-circle-right mr-1"></i>ເເຜນທີ່ບໍ່ສຳເລັດ </router-link>
                    </div>
