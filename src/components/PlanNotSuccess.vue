                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content ">
                            <div class="modal-header bg-info">
                                <h4 class="modal-title">ຟອມເເກ້ໄຂຂໍ້ມູນ ເເຜນການ</h4>
    ...
    export default {
        ...
        methods: {
            async ShowPlanNOTSuccess() {
                try {
                    const response = await axios.get('http://localhost:3000/api/select-plan-unsuccess');
            ...
            async UpdatePlan() {
                try {
                    ...
                    console.log(response.data);
                    this.$router.push('/plan-un-success');
